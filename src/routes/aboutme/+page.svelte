...
<div class="text">
    ...
    <li>C# (Unity)</li>
    <li>dart (flutter)</li>
    <li>elisp (just for emacs)</li>
    <li>go (fiber, hugo)</li>
    <li>haskell</li>
    <li>java (spring boot)</li>
    <li>julia</li>
    <li>javascript/typescript (svelte, react and vue)</li>
    <li>lua (mc, nvim)</li>
    <li>nim</li>
    <li>perl (idk why i did this)</li>
    <li>python (scikit, panads)</li>
    <li>r (rocket, bevy)</li>
    <li>rust</li>
    <li>solidity</li>
</div>
...
<div class="text">
    <p>
        ...
        go against my vision of open source projects. However more cleaner look of my projects can be found on my <a
            class="code"
