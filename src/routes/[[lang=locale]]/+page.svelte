<script>
  ...
  import { localizedPath, postPath } from "$lib/utils/seo";
  import {
...
<!-- The home page owns its title outright, so it opts out of the site suffix. -->
<Seo
  ...
  <section class="recent">
    <div class="activity-grid">
      {#if data.latestPost}
        <ActivityCard
          kind="post"
          href={localizedPath(postPath(data.latestPost.slug), $locale)}
      ...
      {#if data.latestProject}
        <ActivityCard
          kind="project"
          href={data.latestProject.github_url ||
